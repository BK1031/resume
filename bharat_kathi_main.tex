...
\begin{minipage}[t]{0.5\textwidth}
    ...
    \hfill
    \begin{minipage}[t]{0.73\textwidth}
        AWS, Azure, Docker, Firebase, GCP, Git, Kafka, Kubernetes, PostgreSQL, RabbitMQ, SingleStore
    \end{minipage}
...
\begin{entrylist}
    ...
    \entry
        ...
        \begin{itemize}[noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt, leftmargin=10pt]
            ...
            \item Designed and implemented a Finite State Machine to handle all the car's required modes of operations and error states
            \item Led the development of Mapache, our data acquisition + analytics platform which sends data from the car's 200+ sensors through an LTE module using RabbitMQ to an ingest service deployed on AWS
            ...
            \item Sensor data is pipelined using Kafka to a SingleStore server where continuous SQL queries are run to derive useful metrics and insights about the car's performance and send alerts if any anomalies are detected
        \end{itemize}}
	\entry
		{}
